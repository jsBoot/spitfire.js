describe("Array basics test suite", function(){
  ...
  describe("Push", function(){
    ...
    it("Whole set, with a one value array", function(){
      runs(function(){
        var a = ["string"];
        var t = a.push(NaN, Infinity, undefined, false, true, -1, 1, 0.5, "string", {}, [], /a/, function(){}, new (function(){})(),
  ...
  describe("Unshift", function(){
    ...
    it("Whole set, with a one value array", function(){
      runs(function(){
        var a = ["string"];
        var t = a.unshift(NaN, Infinity, undefined, false, true, -1, 1, 0.5, "string", {}, [], /a/, function(){}, new (function(){})(),
          new Object(), new Array(), new RegExp(), new Function());
        expect(a.length).toEqual(t);
        expect(a.length).toEqual(19);
        expect(a[0] == NaN);
  ...
  describe("Sort", function(){
    xit("Sorting whole shebang array", function(){
      runs(function(){
        ...
        var ftoo = function(){};
        var t = [NaN, Infinity, undefined, false, true, -1, 1, 0.5, "string", {}, [], /a/, ftoo, new (function(){})(),
          new Object(), new Array(), new RegExp(), fun, new String(), new Boolean()
        ];

        var s = [NaN, Infinity, undefined, false, true, -1, 1, 0.5, "string", {}, [], /a/, ftoo, new (function(){})(),
          new Object(), new Array(), new RegExp(), fun, new String(), new Boolean()
        ];

        var q = t.sort();
        expect(q).toEqual(t);
        // var compare = [[], [], -1, new RegExp(), /a/, 0.5, 1, Infinity, NaN, {}, {}, {}, false, function(){}, new Function(), "string", true, undefined];
